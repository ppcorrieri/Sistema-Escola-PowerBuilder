...
dw_settings.SetItem(1, "conntype", Long(of_getreg("ConnType", "0")))
dw_settings.SetItem(1, "authmethod", Long(of_getreg("AuthMethod", "2")))
dw_settings.SetItem(1, "characterset", of_getreg("Charset", "windows-1252"))
...
event clicked;of_setreg("Server", dw_settings.GetItemString(1, "server"))
